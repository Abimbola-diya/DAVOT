...
export const InventoryView: React.FC<InventoryViewProps> = ({
  ...
  return (
    <div style={{ paddingBottom: '30px' }}>
      {selectedItem ? (
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px' }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                  <span 
                    style={{ 
                      background: getTypeBadgeStyle(selectedItem.item_type).bg, 
                      color: getTypeBadgeStyle(selectedItem.item_type).text, 
                      border: `1.5px solid ${getTypeBadgeStyle(selectedItem.item_type).border}`,
                      borderRadius: '6px',
                      padding: '2px 8px',
                      fontSize: '11px',
                      fontWeight: 900,
                  ...
                  <span 
                    style={{ 
                      background: getStatusBadgeStyle(getItemStatus(selectedItem)).bg, 
                      color: getStatusBadgeStyle(getItemStatus(selectedItem)).text, 
                      border: `1.5px solid ${getStatusBadgeStyle(getItemStatus(selectedItem)).border}`,
                      borderRadius: '8px',
                      padding: '2px 8px',
                      fontSize: '11px',
                      fontWeight: 800,
                  ...
                  >
                    <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: getStatusBadgeStyle(getItemStatus(selectedItem)).dot }} />
        ...
        <div>
          ...
          >
            ...
            {/* Slot 3 (Bottom Left): Low Stock (Soft Blue #e0f2fe) */}
            <div
              className="neobrutal-card"
              style={{
                background: '#e0f2fe',
            ...
            {/* Slot 4 (Bottom Right): Out of Stock (Soft Lavender #f3e8ff) */}
            <div
              className="neobrutal-card"
              style={{
                background: '#f3e8ff',
      ...
      {/* ALL MODALS RENDERED AT TOP-LEVEL WRAPPER SO THEY OPEN FROM ANY SCREEN */}
      {/* MODAL 1: ADD INPUT */}
      {isAddInputModalOpen && (
